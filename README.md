...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:e8f4fd,50:dbeafe,100:bfdbfe&height=130&section=header&fontColor=1e3a5f&fontSize=0" width="100%"/>
...
<a href="https://github.com/HeshanPramuditha">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=36&pause=1000&color=1e3a5f&center=true&vCenter=true&width=600&lines=Heshan+Pramuditha;AI+%26+ML+Engineer;Computer+Vision+%7C+LLMs+%7C+RAG" alt="Typing SVG" />
</a>
...
![ChromaDB](https://img.shields.io/badge/ChromaDB-FF6C37?style=flat-square&logoColor=white)
...
> Fine-tuned **YOLOv8** on custom Sri Lankan satellite imagery achieving **80% mAP** for rooftop segmentation. **LangChain + ChromaDB RAG** pipeline grounded in CEB technical documentation.
...
> Modular ML system with automated data cleaning, feature engineering & training. **GitHub Actions → Docker → AWS ECR → EC2** zero-touch deployment with custom logging.
...
> Responsive component-based **React.js** frontend with dynamic state management and secure **Stripe** payment integration across all device sizes.
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:bfdbfe,50:dbeafe,100:e8f4fd&height=100&section=footer" width="100%"/>
